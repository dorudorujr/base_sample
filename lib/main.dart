...
import 'package:base_sample/application_model/repository/sample/mocky_io/account_info/account_info_request.dart';
          ...
          children: <Widget>[
            ...
            FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot<AccountInfoResponse> snapshot) {
                if (snapshot.hasData) {
                  return Text(snapshot.data.accountInfo.lastName);
                } else {
